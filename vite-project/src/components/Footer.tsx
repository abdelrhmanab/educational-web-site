    ...
    <footer>
      <div className="grid grid-cols-1 lg:grid-cols-4 w-full gap-12  bg-gray-950 py-20 px-10 ">
        ...
        <div className="flex flex-col justify-center gap-4 lg:gap-8 text-white">
          ...
          <p className='flex items-center w-fit  transition gap-2 text-gray-300 text-[16px] hover:text-error'><MdAddIcCall /> +(402) 762 441 83</p>
          <p className='flex items-center w-fit  transition gap-2 text-gray-300 text-[16px] hover:text-error'><MdOutlineMailOutline />info@echooling.com</p>
        </div>
        {/*  ----------------  INFO -------------- */}
        ...
        <div className="flex flex-col justify-center gap-4 lg:gap-8 text-white">
          <h3 className='text-3xl font-bold'>Usefull Links</h3>
          <FooterLinks links={UsefullLinks} />
        </div>
        {/*  ----------------  USEFUL LINKS -------------- */}
      ...
      <footer className="footer sm:footer-horizontal bg-sky-950 shadow text-neutral-content items-center p-4">
